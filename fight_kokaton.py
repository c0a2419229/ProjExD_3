...
class Beam:
    ...
    def update(self, screen: pg.Surface):
        ...
        引数 screen：画面Surface
        """
        if check_bound(self.rct) == (True, True):  #縦横チェック
    ...
    while True:
        ...
        for bomb in bombs:
            if bird.rct.colliderect(bomb.rct):
                ...
                screen.blit(txt, [WIDTH//2-160, HEIGHT//2-20])
                pg.display.update()
                time.sleep(1)
                return
